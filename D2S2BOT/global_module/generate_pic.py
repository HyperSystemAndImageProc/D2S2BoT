...
def load_dataset(Dataset):
    if Dataset == 'IN':
        # 'C:\Users\Administrator\Desktop\BS2T\datasets/Indian_pines_corrected.mat'
...
def generate_png(all_iter, net, gt_hsi, Dataset,dataacc, device, total_indices,overall_acc_fdssc):
    pred_test = []
    # with torch.no_grad():
